...
const sequelize = new Sequelize('MusicDB', 'postgres', 'lolkill90', {
...
export const UserInfo = await sequelize.define(
    'userinfo',
    {
        user_id: {
...
export const Music = await sequelize.define(
    'music',
    {
        music_id: {
            type: DataTypes.INTEGER,
...
export const FavoriteTracks = await sequelize.define(
    'favoritetracks',
    {
        favoritetracks_id: {
            onDelete: 'CASCADE',
...
export const PlayList = await sequelize.define(
    'playlist',
    {
        playlist_id: {
            type: DataTypes.INTEGER,
...
export const PlayListMusic = await sequelize.define(
    'playlistmusic',
    {
        playlist_music_id: {
            onDelete: 'CASCADE',
